...
public class ExportSalaryListToXlsx {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Sheet sheet = wb.createSheet("Lista wynagrodzeń");
        ...
        titleCell.setCellValue("Wynagrodzenia pracowników");
        ...
        cell.setCellValue("Pensja zasadnicza");
        cell.setCellStyle(styles.get("item_right"));
        
        cell = row.createCell(5);
        cell.setCellValue("Dodatek stały");
        cell.setCellStyle(styles.get("item_right"));
